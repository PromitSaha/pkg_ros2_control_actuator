...
class KeyboardActuatorController(Node):
    def __init__(self):
        ...
        self.prev_cmd_3 = None
        self.prev_cmd_4 = None
        self.prev_cmd_5 = None
        self.prev_cmd_6 = None
    ...
    def imu_callback(self, msg: Imu):
        ...
        if new_cmd_3 != self.prev_cmd_3:
            self.prev_cmd_3 = new_cmd_3
            self.send_command(3, new_cmd_3)

        if new_cmd_4 != self.prev_cmd_4:
            self.prev_cmd_4 = new_cmd_4
            self.send_command(4, new_cmd_4)
        
        if new_cmd_5 != self.prev_cmd_5:
            self.prev_cmd_5 = new_cmd_5
            self.send_command(5, new_cmd_5)

        if new_cmd_6 != self.prev_cmd_6:
            self.prev_cmd_6 = new_cmd_6
            self.send_command(6, new_cmd_6)
